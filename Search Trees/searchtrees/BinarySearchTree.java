...
public class BinarySearchTree<AnyType extends Comparable<? super AnyType>>
{
 ...
 public void printAndSaveTree(String path )
 {
     if( isEmpty( ) )
     ...
     else
     {
    	 ...
    	 printAndSaveTree( root , path);
     }
 }
 private void printAndSaveTree( BinaryNode<AnyType> t, String path )
 {
     
     if( t != null )
     {
    	 printAndSaveTree( t.left, path );
         System.out.println( t.element );
         
         try {
        	 FileWriter fw = new FileWriter(path,true);
             String s = (String) t.element;
             fw.write( s + "\n");
             fw.close();
         }
         catch (IOException e){
